...
adoptLimit: "Your home is full — up to {max} companions. A spot opens if one crosses the rainbow bridge.",
quota: "Companions: {n} / {max}",
...
/* Private messages (/messages) — key-for-key with zh */
  ...
  zh: {
    ...
    pet: {
      ...
      adopted: "欢迎回家，{n}！🎉",
adoptLimit: "家里住满啦——最多 {max} 只伙伴。有伙伴去彩虹桥后空位会再开放。",
quota: "伙伴名额：{n} / {max}",
      namePh: "给它起个名字…",
      personality: "性格",
      customTitle: "上传你的角色",
