...
export const messages = {
  en: {
    ...
    bottle: {
      ...
      quotaSyncing: "Syncing your quota…",
      quotaUnavailable: "Today's count is decided by the server and is not available right now — sending and fishing still work.",
...
/* Private messages (/messages) — key-for-key with zh */
    ...
    profile: {
      ...
      appGoogleFail: "Google sign-in didn't finish ({r}). Please try again.",
      lockedOut: "Too many wrong attempts — this email is paused for {h} hour(s). Please come back later.",
  ...
  zh: {
    ...
    bottle: {
      ...
      leftSend: "今天还能投 {n} 封",
      quotaSyncing: "次数同步中……",
      quotaUnavailable: "今天的次数由服务器为准，暂时没取到；投信与捞信照常，超限会被服务器挡住。",
      send: "投进海里",
      seaTitle: "温暖的海",
      fish: "捞一瓶",
      leftFish: "今天还能捞 {n} 瓶",
...
/* 私信（/messages）：与 en 的键一一对应 */
    ...
    profile: {
      ...
      authFail: "没成功：{r}",
      appGoogleFail: "谷歌登录没能完成（{r}），再试一次就好。",
      lockedOut: "密码错误次数太多啦——这个邮箱先休息 {h} 小时，之后再试。",
