...
export const messages = {
  en: {
    ...
    bottle: {
      ...
      rules: "Up to {w} letters and {f} bottles a day · throw it back if you don't feel like replying · replies are visible only to the writer.",
...
/* Private messages (/messages) — key-for-key with zh */
  ...
  zh: {
    ...
    bottle: {
      ...
      fish: "捞一瓶",
      leftFish: "今天还能捞 {n} 瓶",
      rules: "每天最多投 {w} 封、捞 {f} 瓶 · 捞到不想回可以放回海里 · 回信只有写信人能看到。",
      fromSea: "来自海里的一封信",
      ...
      errFishLimit: "今天捞的次数用完了（每天 7 瓶）——明天再来 🌊",
