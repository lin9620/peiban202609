...
export const messages = {
  en: {
    ...
    community: {
      ...
      dislikeRule: "If 5 or more people tap Dislike (and that's over 1% of reads), the note steps aside to rest — it's kept, not deleted.",
...
/* Private messages (/messages) — key-for-key with zh */
  ...
  zh: {
    ...
    community: {
      ...
      dislikeRule: "当 5 位以上小伙伴都按了「不喜欢」（并且超过浏览的 1%），这条会先从墙上退下休息——不会删掉，随时能回来。",
